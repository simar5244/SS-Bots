...
export const IMPACT_CATEGORIES: Record<string, CriterionImpact> = {
  ...
  '1.3.5 Identify Input Purpose (Level A 2.1 and 2.2)': {
    criterion: '1.3.5 Identify Input Purpose (Level A 2.1 and 2.2)',
    impactCategory: 'Standard',
    wcag20: false,
    wcag21: true,
    wcag22: true,
    disabilities: { blindness: false, lowVision: false, colorblindness: false, hearingLoss: false, cognitiveDisorders: false, motorDisabilities: false, epilepsy: false }
  },
  ...
  '1.4.10 Reflow (Level A 2.1 and 2.2)': {
    criterion: '1.4.10 Reflow (Level A 2.1 and 2.2)',
    impactCategory: 'Extremely important',
    wcag20: false,
    wcag21: true,
    wcag22: true,
  ...
  '1.4.11 Non-text Contrast (Level A 2.1 and 2.2)': {
    criterion: '1.4.11 Non-text Contrast (Level A 2.1 and 2.2)',
    impactCategory: 'Somewhat important',
    wcag20: false,
    wcag21: true,
    wcag22: true,
  ...
  '1.4.12 Text Spacing (Level A 2.1 and 2.2)': {
    criterion: '1.4.12 Text Spacing (Level A 2.1 and 2.2)',
    impactCategory: 'Standard',
    wcag20: false,
    wcag21: true,
    wcag22: true,
...
export function getCriterionImpact(criterionName: string): CriterionImpact | null {
  return IMPACT_CATEGORIES[criterionName] || null;
}

export function getCriteriaByWCAGVersion(version: number): CriterionImpact[] {
  const results: CriterionImpact[] = [];
  
  for (const [_, impact] of Object.entries(IMPACT_CATEGORIES)) {
    if (version === 2.0 && impact.wcag20) {
      results.push(impact);
    } else if (version === 2.1 && impact.wcag21) {
      results.push(impact);
    } else if (version === 2.2 && impact.wcag22) {
      results.push(impact);
    }
  }
